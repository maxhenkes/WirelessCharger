...
public class GuiPersonalCharger extends GuiBase {
    ...
    public GuiPersonalCharger(EntityPlayer player, TileEntityBase tile){
        super(new ContainerPersonalCharger(player, tile));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.fontRenderer.drawString(tilePersonalCharger.getPlayerName(), this.guiLeft + this.xSize/2 - this.fontRenderer.getStringWidth(range)/2, this.guiTop + 19, 0xF5DA81);
